...
?>
<div id="UploadFrame">
    <iframe width="100%" height="50px" style="border:0;" src="<?php echo get_option( 'siteurl' ); ?>/wp-content/plugins/scormcloud/uploadpif.php?id=<?php echo $packageid; ?>" id="ifmImport" ></iframe>
</div>

<?php
$coursesFilter = null;
if (scormcloud_isScormCloudNetworkManaged() && get_site_option('scormcloud_sharecourses') !== 'on'){
...
<table class="widefat" cellspacing="0" id="CourseListTable" >
    <thead>
        <tr class="thead"><th class="manage-column"><?php _e("Course Title","scormcloud"); ?></th><th colspan="5" class="manage-column"></tr>
    </thead>
<?php    
