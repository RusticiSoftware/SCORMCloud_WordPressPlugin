...
<a class='backLink' href='<?php echo get_option( 'siteurl' )."/wp-admin/admin.php?page=scormcloudtraining"; ?>'><?php _e("Go back to all trainings","scormcloud"); ?></a>
...
<div title='<?php _e("Click to toggle","scormcloud"); ?>' class='handlediv'><br></div><h3 class='hndle'><span><?php _e("Invitation Details","scormcloud"); ?></span></h3>
<div class='inside'>
    ...
    <table class='inviteDetails'>
        ...
        <td class='inviteDetails'>
            ...
            <table class='inviteForm'>
                ...
                <tr>
                    <td colspan='2'><input type="checkbox" <?php echo ($invite->require_login == 1 ? "checked" : ""); ?> name="trainingRequireLogin"/><?php _e("Require that learners be authenticated users.","scormcloud"); ?></td>
                </tr>
                <tr>
                    <td colspan='2'><input type="checkbox" <?php echo ($invite->show_course_info == 1 ? "checked" : ""); ?> name="showCourseInfo"/><?php _e("Show the course title and description.","scormcloud"); ?></td>
                </tr>
                
            </table>
            
            <input type="button" class="updateInvitation button" name="generateTrainingTag" value="<?php _e("Update This Training","scormcloud"); ?>" />
...
<div class='handlediv'><br></div><h3 class='hndle'><span><?php _e("Training Summary","scormcloud"); ?></span><a href='javascript:void(0);' key='<?php echo $invite->invite_id; ?>' class='viewReportageLink reportageLink' ><?php _e("View Full Results Report","scormcloud"); ?></a></h3>
<div class='inside'>
<?php
...
<h3><?php _e("Training History","scormcloud"); ?> <a class='reportageLink' href='<?php echo $reportageViewAllUrl; ?>'><?php _e("View All Learners in Reportage","scormcloud"); ?></a></h3>
