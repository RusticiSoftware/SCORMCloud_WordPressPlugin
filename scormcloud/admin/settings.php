...
<br />
<?php _e("If you need an account on SCORM Cloud, ","scormcloud"); ?><a
	href="https://cloud.scorm.com" target="_blank"
	title="<?php _e("Open the SCORM Cloud Site in a new window.","scormcloud"); ?>"><?php _e("click here to go there now","scormcloud"); ?></a>.</em></p>

<form name="scormcloud_form" method="post"
...
<p><?php _e("App ID: ","scormcloud" ); ?><input type="text"
	name="scormcloud_appid" value="<?php echo $appid; ?>" size="20"> <br />
<em><?php _e(" ex: MYAYX1KB3G","scormcloud" ); ?></em></p>
<p><?php _e("Secret Key: ","scormcloud" ); ?><input type="text"
	name="scormcloud_secretkey" value="<?php echo $secretkey; ?>" size="50">
<br />
<em><?php _e(" ex: fJ4Q2HwEZbhRLeftHLv0SjzIVpJLXRiyfyOiWBo0","scormcloud" ); ?></em></p>
...
<p class="submit"><input type="submit" name="Submit"
	value="<?php _e("Update Settings","scormcloud" ) ?>" /></p>
</form>
</div>
