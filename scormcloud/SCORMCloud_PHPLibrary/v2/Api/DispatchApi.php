...
class DispatchApi
{
     ...
     *
     * Create one or many destinations
     *
     ...
     *
     * Create one, or many, dispatches in one, or many, destinations
     *
     ...
     *
     * Delete dispatches from a destination
     *
     * @param  string $destination_id Identifier for the destination (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     ...
     *
     * Clear postback information from a dispatch
     *
     * @param  string $dispatch_id Identifier for the dispatch (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     ...
     *
     * Get the registration count for all of a destination's dispatches
     *
     * @param  string $destination_id Identifier for the destination (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     ...
     *
     * Get a zip file containing a destination's dispatches
     *
     * @param  string $destination_id Identifier for the destination (required)
     * @param  string $type The type of dispatch package to export (SCORM_12 only supported in cloud today) (optional, default to SCORM_12)
     ...
     *
     * Get the registration count for a dispatch
     *
     * @param  string $dispatch_id Identifier for the dispatch (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     ...
     *
     * Apply tags to this destination
     *
     * @param  string $destination_id Identifier for the destination (required)
     * @param  \RusticiSoftware\Cloud\V2\Model\TagListSchema $tags tags (required)
     *
     ...
     *
     * Apply a group of tags to a group of destinations
     *
     ...
     *
     * Apply a group of tags to a group of dispatches
     *
     * @param  \RusticiSoftware\Cloud\V2\Model\BatchTagsSchema $batch Array of ids, and array of tags for bulk tag operations (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     ...
     *
     * Reset registration counts for all of a destination's dispatches
     *
     * @param  string $destination_id Identifier for the destination (required)
     *
     * @throws \RusticiSoftware\Cloud\V2\ApiException on non-2xx response
     ...
     *
     * Set the `enabled` status for all of a destination's dispatches
     *
     * @param  string $destination_id Identifier for the destination (required)
     * @param  \RusticiSoftware\Cloud\V2\Model\EnabledSchema $enabled  (required)
     *
     ...
     *
     * Set the `enabled` status for a dispatch
     *
     * @param  string $dispatch_id Identifier for the dispatch (required)
     * @param  \RusticiSoftware\Cloud\V2\Model\EnabledSchema $enabled  (required)
     *
     ...
     *
     * Set user PII hashing status for destination
     *
     * @param  string $destination_id Identifier for the destination (required)
     ...
     *
     * Update properties of a dispatch
     *
     * @param  string $dispatch_id Identifier for the dispatch (required)
     ...
     *
     * Set user PII hashing status for a dispatch
     *
     * @param  string $dispatch_id Identifier for the dispatch (required)
     * @param  \RusticiSoftware\Cloud\V2\Model\EnabledSchema $enabled enabled (required)
     *
